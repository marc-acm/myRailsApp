...
class MedicinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post medicines_url, params: { medicine: { date: @medicine.date, dosage: @medicine.dosage, in_take: @medicine.in_take, med_name: @medicine.med_name } }
    end
  ...
  test "should update medicine" do
    patch medicine_url(@medicine), params: { medicine: { date: @medicine.date, dosage: @medicine.dosage, in_take: @medicine.in_take, med_name: @medicine.med_name } }
